...
At the time of writing, to the best of our knowledge there isn'ôt a python package the implements these various financial data structures and also there are no sources that share data of this kind.  Our two key contributions will be a python package the implements these various financial data structures along with a test data set.
